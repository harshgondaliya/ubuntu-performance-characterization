...
def main():
    ...
    print("trimmed mean time (rounded): " + str(round(trimmed_mean*0.344,1)))
    print("trimmed stddev time (rounded): " + str(round(trimmed_stddev*0.344,1)))
    ...
    tfname.write("trimmed mean time (rounded): " + str(round(trimmed_mean*0.344,1)) + "\n")
    tfname.write("trimmed stddev time (rounded): " + str(round(trimmed_stddev*0.344,1)) + "\n")
    tfname.close()
    f.close()
