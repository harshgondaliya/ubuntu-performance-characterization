...
def main():
    ...
    print("trimmed mean (rounded) in time: " + str(round(trimmed_mean*0.344,2)))
    print("trimmed stddev (rounded) in time: " + str(round(trimmed_stddev*0.344,2)))
    ...
    tfname.write("trimmed mean (rounded) in time: " + str(round(trimmed_mean*0.344,2)) + "\n")
    tfname.write("trimmed stddev (rounded) in time: " + str(round(trimmed_stddev*0.344,2)) + "\n")
    tfname.close()
    f.close()
