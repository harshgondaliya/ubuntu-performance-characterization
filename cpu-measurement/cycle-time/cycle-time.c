...
void main(){    
    ...
    outputFile = fopen("cycle-time.txt", "w");
    ...
    // mean_cycle_time = (1000000000 * (double)SLEEP_DURATION/mean);
    // printf("\n\nTrials: %d\nMean Cycles for %ds duration: %lf\nStddev: %lf\n", NO_OF_TRIALS, SLEEP_DURATION,mean, stddev);
    // printf("Mean Cycle Time: %lf",mean_cycle_time);
}
